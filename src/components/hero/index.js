...
import Profile from "../../img/A-robot-using-a-laptop.webp";
          ...
          <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
            <div className="max-w-xl mb-6 lg:text-end">
              <h2 className="font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none max-w-lg mb-6">
                Hi there, I'm{" "}
                <span className="inline-block text-blue-accent-700">Praveen</span>
              </h2>
              <p className="text-gray-700 text-base md:text-lg">
                I'm a Full Stack Web Developer based in Tirupati, AP.
              </p>
            </div>
