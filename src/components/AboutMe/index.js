...
const AboutMe = () => {
  ...
  <div className="w-full lg:w-1/2 flex flex-col justify-center p-2 py-8">
    <p className="text-base text-gray-400 md:text-lg text-center">
      My name is Praveen and I am a talented barber and full stack developer.
      I have been working in the barbering industry for two decades and have
      developed a keen eye for details. In my free time, I enjoy listening to
      music and drawing, I have always had a love for music and find that it
      helps to relax and inspire me in my work.
    </p>
    <p className="mt-4 text-base text-gray-400 md:text-lg text-center">
      I initially started coding as a hobby, but quickly realized that it was
      something I was truly passionate about and decided to pursue a career
      change. It was a big decision, but I am excited to be able to do what I
